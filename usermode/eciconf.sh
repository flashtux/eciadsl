...
frame .fai
frame .fai.espace -width 130
label .fai.votre_fai -text {Internet provider :} -relief groove -background "#ffcc99" -width 32
pack .fai.espace .fai.votre_fai -side left
pack .fai -anchor w

frame .wanadoo
frame .wanadoo.espace -width 155
radiobutton .wanadoo.rwanadoo -text "Wanadoo" -variable fai -value wanadoo -command {set dns1 "193.252.19.3"; set dns2 "193.252.19.4"} -padx 10 -anchor w
pack .wanadoo.espace .wanadoo.rwanadoo -side left
pack .wanadoo -anchor w

frame .clubinternet
frame .clubinternet.espace -width 155
radiobutton .clubinternet.rclubinternet -text "Club Internet" -variable fai -value clubinternet -command {set dns1 "194.117.200.15"; set dns2 "194.117.200.10"} -padx 10
pack .clubinternet.espace .clubinternet.rclubinternet -side left
pack .clubinternet -anchor w

frame .9telecom
frame .9telecom.espace -width 155
radiobutton .9telecom.r9telecom -text "9 Telecom (unknown)" -variable fai -value 9telecom -command {set dns1 "unknown ! edit me !"; set dns2 "unknown ! edit me !"} -padx 10 -state disabled
pack .9telecom.espace .9telecom.r9telecom -side left
pack .9telecom -anchor w

frame .cegetel
frame .cegetel.espace -width 155
radiobutton .cegetel.rcegetel -text "Cegetel" -variable fai -value cegetel -command {set dns1 "194.6.128.3"; set dns2 "194.6.128.4"} -padx 10
pack .cegetel.espace .cegetel.rcegetel -side left
pack .cegetel -anchor w

frame .worldonline
frame .worldonline.espace -width 155
radiobutton .worldonline.rworldonline -text "World Online" -variable fai -value worldonline -command {set dns1 "212.83.128.3"; set dns2 "212.83.128.4"} -padx 10
pack .worldonline.espace .worldonline.rworldonline -side left
pack .worldonline -anchor w

frame .telecomitalia
frame .telecomitalia.espace -width 155
radiobutton .telecomitalia.rtelecomitalia -text "Telecom Italia" -variable fai -value telecomitalia -command {set dns1 "212.216.112.112"; set dns2 "212.216.172.62"} -padx 10
pack .telecomitalia.espace .telecomitalia.rtelecomitalia -side left
