...
% sur une seule page :
%
% latex2html -split 0 -show_section_numbers howto howto.tex
%
% pour passer en texte :
%
% lynx -dump howto.html > howt.txt
% 
% note : avant de passer en ascii, il est préférable de faire :
% 
% latex2html -ascii_mode -show_section_numbers -split 0 howto howto.tex
%
...
\author{Bertrand Rougier, Thierry De Baere, Florent Manens }
...
\section {Procédure d'installation (à ne faire qu'une seule fois)}
	Référence : archive usermode.tgz presente sur http://flashcode.free.fr/linux
...
\subsection{Préparation du driver}
	...
	\footnote{(pour connaite la version du noyau tapez : uname -r)}
