...
Si vous voulez utilisez l'option 'persist' de pppd afin que votre
connexion se reconnecte automatiquement, alors, il faut patcher votre noyau.
Vous trouverez le patch au sein de l'archive des drivers.
