...
\end{verbatim}
    ...
    2 possibilit\'es pour enlever ce module :
    
    \textbf{1)} Par eciconf.sh : d\'ebranchez votre modem puis dans eciconf.sh cliquez
    sur "Remove dabusb module".
    
    \textbf{2)} Tapez les commandes suivantes en remplaçant VERSION par la version de
    votre noyau Linux : 
...
Il y a 2 façons de changer le .bin :
    ...
    \subsubsection{Façon 1 :}
        ...
        le changement se fait dans eciconf.sh
