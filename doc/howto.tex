...
\textbf{eci-doctor.sh}. Ensuite, ajouter l'option \textbf{persist} au
...
\htmladdnormallink{OpenProjects.Net}{http://www.openprojetc.net/} sur
le channel \textbf{\#eci} en utilisant le serveur
\textbf{irc.openprojects.net} par exemple.
